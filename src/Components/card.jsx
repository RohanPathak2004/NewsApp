...
const Card = ({news}) => {
    ...
    return (
        <div
            className='min-w-[90%] px-4 flex flex-col  md:flex-row  items-start gap-1 border border-gray-200 py-4 mt-2 mb-2 hover:shadow hover:shadow-zinc-400 transition ease-out  duration-150 dark:bg-neutral-900  '>
